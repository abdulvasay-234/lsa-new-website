...
export function ContactPage() {
  return <>
    <Section className="contact-page-hero"><Container className="contact-page-hero-layout"><div><p className="section-marker section-marker-yellow">01 — GET IN TOUCH</p><h1>Let&apos;s talk about<br />what comes next.</h1><p>Whether you&apos;re looking to build new skills, find the right learning path, or work with LSA, tell us what you&apos;re looking for.</p></div><div className="contact-page-hero-rule" aria-hidden="true" /></Container></Section>
