...
export function AboutPage() {
  return (
    <>
      <Section className="about-page-hero"><Container className="about-page-hero-layout"><div><p className="section-marker section-marker-yellow">01 — ABOUT LSA</p><h1>Technology education<br />built around capability.</h1><p>Lords Skill Academy (LSA) helps learners develop practical technology skills through structured learning, hands-on projects, industry exposure, and career-focused guidance.</p></div><div className="about-hero-visual" aria-label="LSA practical technology education visual" role="img"><span>LSA / 01</span><strong>KNOW<br />DO<br />SHOW</strong><i>Practical technology education</i></div></Container></Section>

      <Section className="about-page-why"><Container className="about-page-why-layout"><div className="about-page-heading"><p className="section-marker">02 — WHY LSA</p><h2>Learning technology should lead to doing.</h2></div><div><p className="about-page-statement">Learning should move beyond completing lessons. It should help learners build practical skills, gain real experience, solve problems, and create evidence of what they can do.</p><p className="about-page-muted">LSA connects knowledge to action through technology programs, hands-on learning, projects, campus experiences, and career guidance.</p><div className="about-sequence">{['LEARN', 'BUILD', 'SOLVE', 'EXPERIENCE', 'SHOWCASE'].map((item, index) => <span key={item}><b>{`0${index + 1}`}</b>{item}{index < 4 && <i aria-hidden="true">→</i>}</span>)}</div></div></Container></Section>
